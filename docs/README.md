...
| 5 — Sorteo en vivo y cierre | [Contrato_Fase5.md](Fase_5/Contrato_Fase5.md) | [Plan_Implementacion_Fase5.md](Fase_5/Plan_Implementacion_Fase5.md) | Implementación de las 27 tareas completa en `feature/fase-5-sorteo`; falta correr el ensayo manual ([Ensayo.md](Fase_5/Ensayo.md)) con hardware real antes de dar la fase por cerrada |
